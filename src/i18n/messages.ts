...
const messages = {
  ko: {
    ...
    "settings.autoSaveDirError": "선택한 경로에 접근할 수 없어 로컬 라이브러리의 불러오기와 저장을 중단했습니다.",
    "settings.autoSaveDirUnavailableTitle": "사용자 지정 저장 경로에 연결할 수 없습니다",
    "settings.autoSaveDirUnavailable": "예상 경로: {{path}}",
    "settings.autoSaveDirUnavailableHelp": "로컬 라이브러리의 불러오기와 저장을 중단했습니다. 드라이브를 다시 연결한 뒤 재연결을 확인하거나, 새 경로를 선택하거나, 기본값으로 명시적으로 복원해 주세요. 기본 Documents 폴더는 자동으로 사용하지 않습니다. 클라우드 폴더가 끊겼을 때의 로컬 대체 저장 정책과는 별도로 처리됩니다.",
    "settings.autoSaveRetry": "재연결 확인",
    "settings.autoSaveDirRecoveredTitle": "사용자 지정 저장 경로가 다시 연결되었습니다",
    "settings.autoSaveDirRecoveredHelp": "기존 경로 설정은 그대로 유지되어 있습니다. 라이브러리를 다시 불러오면 이 경로에서 작업을 계속합니다.",
    "settings.autoSaveReload": "라이브러리 다시 불러오기",
    ...
    "settings.cloudSyncRecoveredTitle": "클라우드 저장소 복구 완료",
    "settings.cloudSyncRecovered": "클라우드 저장소가 다시 연결되어 메모를 안전하게 다시 불러왔습니다.",
    "settings.cloudSyncRecoveredWithCopies": "클라우드 저장소가 다시 연결되었습니다. 로컬과 다른 메모 {{count}}개는 덮어쓰지 않고 저장되지 않은 복구 탭으로 열었습니다. 내용을 확인한 뒤 저장해 주세요.",
    "settings.cloudSyncRecoveredCalendarCopy": "로컬 캘린더 변경 사항은 클라우드 캘린더를 다시 불러오기 전에 별도 복구 사본으로 보존했습니다. 필요하면 이 파일을 확인해 주세요:\n{{path}}",
    "settings.cloudSyncRecoveredCopyTitle": "{{title}} (로컬 복구본)",
    "settings.cloudSyncRecoveryFailedTitle": "클라우드 저장소 복구 실패",
    "settings.cloudSyncRecoveryFailed": "클라우드 메모와 캘린더를 안전하게 다시 불러오지 못해 저장을 일시 중단했습니다. 연결 상태를 확인하면 자동으로 다시 시도합니다.",
    "settings.cloudSyncRecoveryFailedWithCalendarCopy": "클라우드 복구를 안전하게 완료하지 못해 저장을 일시 중단했습니다. 로컬 캘린더 변경 사항은 다음 복구 사본에 보존되어 있으며 자동으로 다시 시도합니다:\n{{path}}",
    "settings.cloudSyncMutationBlockedTitle": "노트 작업 일시 중단",
    "settings.cloudSyncMutationBlocked": "클라우드 저장소를 복구하거나 라이브러리를 전환하는 동안에는 노트와 폴더를 변경할 수 없습니다. 복구가 끝난 뒤 다시 시도해 주세요.",
    "settings.calendarSaveFailedTitle": "캘린더 저장 실패",
    "settings.calendarSaveFailed": "캘린더를 저장하지 못해 작업을 중단했습니다. 클라우드 동기화 상태를 확인한 뒤 다시 시도해 주세요.",
    "settings.calendarRecoveryRequiredTitle": "캘린더 데이터 복구 필요",
    "settings.calendarRecoveryRequired": "calendar.json을 읽지 못해 저장을 차단했습니다. 원본은 덮어쓰지 않았습니다. 원본을 복구하거나 캘린더를 명시적으로 초기화한 뒤 다시 시도해 주세요.",
    "settings.calendarRecoveryRequiredWithBackup": "calendar.json을 읽지 못해 저장을 차단했습니다. 원본은 덮어쓰지 않았습니다.\n백업: {{path}}\n백업 또는 원본을 복구한 뒤 다시 시도해 주세요.",
    "notes.recoveryIncompleteTitle": "노트 라이브러리 스캔을 완료하지 못했습니다",
    "notes.recoveryCorruptTitle": "노트 인덱스를 복구해야 합니다",
    "notes.recoveryDescription": "불완전한 결과를 파일 삭제로 오인하지 않도록 기존 노트, 폴더, 인덱스와 캘린더 연결을 그대로 보존했습니다. 아래 경로와 원인을 해결한 뒤 다시 시도해 주세요.",
    "notes.recoveryIndexSource": "인덱스 원본",
    "notes.recoveryIndexBackup": "보호 백업",
    "notes.recoveryUnknownCause": "구체적인 오류 원인을 확인하지 못했습니다. 저장 경로와 권한을 확인해 주세요.",
    "notes.recoveryRetry": "노트 라이브러리 다시 스캔",
    "notes.recoveryRetrying": "다시 스캔하는 중…",
    ...
    "update.noteSaveFailedTitle": "메모 저장 실패",
    "update.noteSaveFailed": "메모 저장을 완료하지 못해 업데이트 설치를 중단했습니다. 저장 위치와 클라우드 동기화 상태를 확인한 뒤 다시 시도해 주세요.",
    "view.notes": "메모",
    "view.calendar": "캘린더",
    "view.switchToCalendar": "캘린더 보기로 전환",
    "view.switchToNotes": "메모 보기로 전환",
    "calendar.title": "캘린더",
    "calendar.loading": "캘린더를 불러오는 중…",
    "calendar.recoveryTitle": "캘린더 데이터를 읽을 수 없습니다",
    "calendar.recoveryDescription": "안전을 위해 캘린더 편집과 저장을 중단했습니다. 원본 또는 백업을 복구한 뒤 다시 불러오거나, 확인 후 빈 캘린더로 초기화할 수 있습니다.",
    "calendar.recoverySource": "원본 파일",
    "calendar.recoveryBackup": "보호 백업",
    "calendar.recoveryError": "오류",
    "calendar.recoveryReload": "디스크에서 다시 불러오기",
    "calendar.recoveryReset": "빈 캘린더로 초기화",
    "calendar.recoveryResetTitle": "캘린더 초기화",
    "calendar.recoveryResetConfirm": "현재 calendar.json을 빈 캘린더로 교체할까요? 보호 백업이 있다면 그대로 유지됩니다. 이 작업은 캘린더 항목을 삭제합니다.",
    "calendar.recoveryResetFailedTitle": "캘린더 초기화 실패",
    "calendar.recoveryResetFailed": "빈 캘린더를 저장하지 못했습니다. 원본은 덮어쓰지 않았습니다. 경로와 권한을 확인한 뒤 다시 시도해 주세요.",
    "calendar.today": "오늘",
  ...
  en: {
    ...
    "titlebar.tabsFull": "Tab strip is full",
    ...
    "settings.autoSaveDirError": "The selected path is unavailable, so loading and saving the local library are paused.",
    "settings.autoSaveDirUnavailableTitle": "The custom storage path is unavailable",
    "settings.autoSaveDirUnavailable": "Expected path: {{path}}",
    "settings.autoSaveDirUnavailableHelp": "Loading and saving the local library are paused. Reconnect the drive and retry, choose a new folder, or explicitly reset to the default. HwanNote will not use the default Documents folder automatically. This is handled separately from the cloud folder's local fallback policy.",
    "settings.autoSaveRetry": "Retry connection",
    "settings.autoSaveDirRecoveredTitle": "The custom storage path is connected again",
    "settings.autoSaveDirRecoveredHelp": "Your existing path setting is still intact. Reload the library to continue from this location.",
    "settings.autoSaveReload": "Reload library",
    ...
    "settings.cloudSyncRecoveredTitle": "Cloud storage restored",
    "settings.cloudSyncRecovered": "Cloud storage is available again, and notes were safely reloaded.",
    "settings.cloudSyncRecoveredWithCopies": "Cloud storage is available again. {{count}} local notes that differed from the cloud were opened as unsaved recovery tabs instead of overwriting cloud files. Review and save them when ready.",
    "settings.cloudSyncRecoveredCalendarCopy": "Local calendar changes were preserved in a separate recovery copy before the cloud calendar was reloaded. Review this file if needed:\n{{path}}",
    "settings.cloudSyncRecoveredCopyTitle": "{{title}} (local recovery)",
    "settings.cloudSyncRecoveryFailedTitle": "Cloud recovery failed",
    "settings.cloudSyncRecoveryFailed": "Cloud notes and calendar could not be reloaded safely, so saving is paused. Check the connection; HwanNote will retry automatically.",
    "settings.cloudSyncRecoveryFailedWithCalendarCopy": "Cloud recovery could not finish safely, so saving is paused. Local calendar changes are preserved in this recovery copy, and HwanNote will retry automatically:\n{{path}}",
    "settings.cloudSyncMutationBlockedTitle": "Note action paused",
    "settings.cloudSyncMutationBlocked": "Notes and folders cannot be changed while cloud storage is recovering or the library is switching. Try again after recovery finishes.",
    "settings.calendarSaveFailedTitle": "Calendar save failed",
    "settings.calendarSaveFailed": "The calendar could not be saved, so the operation was stopped. Check cloud sync and try again.",
    "settings.calendarRecoveryRequiredTitle": "Calendar recovery required",
    "settings.calendarRecoveryRequired": "Saving is blocked because calendar.json could not be read. The original was not overwritten. Recover the original or explicitly reset the calendar, then try again.",
    "settings.calendarRecoveryRequiredWithBackup": "Saving is blocked because calendar.json could not be read. The original was not overwritten.\nBackup: {{path}}\nRecover the backup or original, then try again.",
    "notes.recoveryIncompleteTitle": "The note library scan did not complete",
    "notes.recoveryCorruptTitle": "The note index needs recovery",
    "notes.recoveryDescription": "Existing notes, folders, index data, and calendar links were preserved so an incomplete result is not mistaken for deleted files. Resolve the path and cause below, then retry.",
    "notes.recoveryIndexSource": "Index source",
    "notes.recoveryIndexBackup": "Protected backup",
    "notes.recoveryUnknownCause": "No specific cause was reported. Check the storage path and permissions.",
    "notes.recoveryRetry": "Rescan note library",
    "notes.recoveryRetrying": "Rescanning…",
    ...
    "update.noteSaveFailedTitle": "Note save failed",
    "update.noteSaveFailed": "The update was not installed because note saving could not finish. Check the save location and cloud sync, then try again.",
    "view.notes": "Notes",
    ...
    "calendar.recoveryTitle": "Calendar data could not be read",
    "calendar.recoveryDescription": "Calendar editing and saving are paused for safety. Recover the original or backup and reload it, or explicitly reset to an empty calendar after confirmation.",
    "calendar.recoverySource": "Source file",
    "calendar.recoveryBackup": "Protected backup",
    "calendar.recoveryError": "Error",
    "calendar.recoveryReload": "Reload from disk",
    "calendar.recoveryReset": "Reset to empty calendar",
    "calendar.recoveryResetTitle": "Reset calendar",
    "calendar.recoveryResetConfirm": "Replace the current calendar.json with an empty calendar? Any protected backup will be kept. This deletes the calendar items.",
    "calendar.recoveryResetFailedTitle": "Calendar reset failed",
    "calendar.recoveryResetFailed": "The empty calendar could not be saved. The original was not overwritten. Check the path and permissions, then try again.",
