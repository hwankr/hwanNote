...
const messages = {
  ko: {
    ...
    "settings.cloudSyncHelp": "OneDrive 또는 Google Drive의 로컬 동기화 폴더에 메모를 저장합니다. 해당 앱의 동기화 클라이언트가 설치되어 있어야 합니다.",
    "settings.cloudSyncFolder": "동기화 폴더: {{path}}",
    "settings.cloudSyncNotInstalled": "{{provider}} Desktop이 설치되지 않았습니다.",
    "settings.cloudSyncConfirmEnable": "기존 메모 {{count}}개를 {{provider}}(으)로 복사합니다. 계속하시겠습니까?\n\n원본 메모는 기존 위치에 그대로 보존됩니다.",
    "settings.cloudSyncConfirmDisable": "메모를 로컬 저장소로 복사한 후 클라우드 동기화를 해제합니다.\n\n클라우드 폴더의 메모는 그대로 보존됩니다.",
  ...
  en: {
    ...
    "settings.cloudSyncHelp": "Save notes to the local sync folder of OneDrive or Google Drive. The sync client must be installed.",
    "settings.cloudSyncFolder": "Sync folder: {{path}}",
    "settings.cloudSyncNotInstalled": "{{provider}} Desktop is not installed.",
    "settings.cloudSyncConfirmEnable": "{{count}} existing notes will be copied to {{provider}}. Continue?\n\nOriginal notes will be preserved in their current location.",
    "settings.cloudSyncConfirmDisable": "Notes will be copied to local storage and cloud sync will be disabled.\n\nNotes in the cloud folder will be preserved.",
