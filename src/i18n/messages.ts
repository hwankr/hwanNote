...
const messages = {
  ko: {
    ...
    "settings.cloudSyncRecoveryFailed": "클라우드 메모를 다시 불러오지 못해 메모 저장을 일시 중단했습니다. 연결 상태를 확인하면 자동으로 다시 시도합니다.",
  ...
  en: {
    ...
    "settings.cloudSyncRecoveryFailed": "Cloud notes could not be reloaded, so note saving is paused. Check the connection; HwanNote will retry automatically.",
